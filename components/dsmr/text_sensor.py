...
CONFIG_SCHEMA = cv.Schema(
    {
        ...
        cv.Optional("cosem_device_name"): text_sensor.text_sensor_schema(),
        cv.Optional("serial_number"): text_sensor.text_sensor_schema(),
        cv.Optional("circuit_breaker_state"): text_sensor.text_sensor_schema(),
        cv.Optional("last_month_packed_values"): text_sensor.text_sensor_schema(),
    }
